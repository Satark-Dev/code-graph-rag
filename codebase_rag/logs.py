...
SEMANTIC_PREWARM_START = "Prewarming semantic embedding model..."
SEMANTIC_PREWARM_COMPLETE = "Semantic embedding model ready."
SEMANTIC_PREWARM_FAILED = "Semantic embedding model prewarm failed: {error}"
...
EMBEDDING_GENERATION_FAILED_UNEXPECTED = "An unexpected error occurred during semantic embedding generation"
EMBEDDING_UNEXPECTED_FAILURE = "An unexpected error occurred while embedding {name}"
EMBEDDING_RECONCILE_UNEXPECTED = "An unexpected error occurred during PGVector reconciliation"
EMBEDDING_STORE_FAILED = "Failed to store embedding for {name}: {error}"
EMBEDDING_STORE_RETRY = "PGVector upsert failed (attempt {attempt}/{max_attempts}), retrying in {delay:.1f}s: {error}"
EMBEDDING_BATCH_STORED = "Stored batch of {count} embeddings in PGVector"
EMBEDDING_BATCH_FAILED = "Failed to store embedding batch: {error}"
EMBEDDING_SEARCH_FAILED = "Failed to search embeddings: {error}"
EMBEDDING_RECONCILE_OK = "PGVector reconciliation: all {count} expected embeddings found"
EMBEDDING_RECONCILE_MISSING = "PGVector reconciliation: {missing} of {expected} embeddings missing (IDs: {sample_ids})"
EMBEDDING_RECONCILE_FAILED = "PGVector reconciliation check failed: {error}"
PGVECTOR_DELETE_PROJECT = "Deleting {count} PGVector embeddings for project '{project}'"
PGVECTOR_DELETE_PROJECT_DONE = "Deleted PGVector embeddings for project '{project}'"
PGVECTOR_DELETE_PROJECT_FAILED = (
    "Failed to delete PGVector embeddings for project '{project}': {error}"
)
PGVECTOR_CLIENT_MODE = "PGVector client mode: {mode} ({details})"
...
SEMANTIC_RERANK_FAILED = "Semantic rerank failed: {error}"
