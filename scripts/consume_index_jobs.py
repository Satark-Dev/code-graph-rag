#!/usr/bin/env python3
"""
Dedicated worker: Kafka index jobs consumer (same GraphUpdater as /api/index).

Usage (from repo root, with .env loaded):

  uv run python scripts/consume_index_jobs.py
"""
...
from codebase_rag.services.kafka.index_job_consumer import (  # noqa: E402
