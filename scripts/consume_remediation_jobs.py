#!/usr/bin/env python3
"""
Dedicated worker: Kafka remediation jobs consumer (stage 3 of chat pipeline).

Usage (from repo root, with .env loaded):

  uv run python scripts/consume_remediation_jobs.py
"""
...
from codebase_rag.services.kafka.remediation_job_consumer import (  # noqa: E402
...
async def _main() -> None:
    ...
    ingestor.__enter__()
    try:
        await run_remediation_job_consumer(
            ingestor=ingestor,
            stop_event=stop,
