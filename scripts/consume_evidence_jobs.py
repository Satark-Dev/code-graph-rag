#!/usr/bin/env python3
"""
Dedicated worker: Kafka evidence jobs consumer (stage 1 of chat pipeline).

Usage (from repo root, with .env loaded):

  uv run python scripts/consume_evidence_jobs.py
"""
...
from codebase_rag.services.kafka.evidence_job_consumer import (  # noqa: E402
...
async def _main() -> None:
    ...
    ingestor.__enter__()
    try:
        await run_evidence_job_consumer(
            ingestor=ingestor,
            stop_event=stop,
