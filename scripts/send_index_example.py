...
async def send_index_example() -> None:
    ...
    # org_tool_findings_id = branch asset row id (type='asset'); branch name = that row's name.
    org_tool_findings_id = "4395a501-c99c-43ac-b86c-0354eb36c6fd"
    invocation_id = str(uuid.uuid4())

    payload = IndexJobPayload(
        org_id=org_id,
        repo_url=repo_url,
        org_tool_findings_id=org_tool_findings_id,
        clean=True,
        exclude=None,
